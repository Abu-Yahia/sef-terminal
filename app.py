...
# --- 2. Database Logic (الربط مع ملف GitHub) ---
...
with c1:
    ...
    # الربط: تحميل البيانات تلقائياً عند اختيار السهم
...
if st.session_state['ready']:
    ...
    # Fair Value Position logic
    if fv_in > 0:
        pos_fv = max(5, min(95, 50 + (((p_in - fv_in)/fv_in)*200)))
    else:
        pos_fv = 50
            ...
            <div style="display: flex; gap: 40px; text-align: right;">
                <div style="width: 150px;">
                    ...
                    <div style="display: flex; justify-content: space-between; font-size: 0.75em; margin-top: 5px;">
                        <span>{st.session_state['low52']:.1f}</span>
                        <span>{st.session_state['high52']:.1f}</span>
                    </div>
                </div>
